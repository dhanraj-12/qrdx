...
export function usePlaygroundShortcuts({
  ...
  useKeyboardShortcut(",", () => {
    ...
    const currentIndex = bodyPatterns.findIndex((p) => p.id === currentPattern);
    const nextIndex = (currentIndex + 1) % bodyPatterns.length;
    setThemeState({
      ...themeState,
      styles: { ...themeState.styles, bodyPattern: bodyPatterns[nextIndex].id },
    });
  }, { enabled: shortcutsEnabled });
  ...
  useKeyboardShortcut("1", () => handleSetTab(tabs[0] as any), { enabled: shortcutsEnabled });
  useKeyboardShortcut("2", () => handleSetTab(tabs[1] as any), { enabled: shortcutsEnabled });
  useKeyboardShortcut("3", () => handleSetTab(tabs[2] as any), { enabled: shortcutsEnabled });
  useKeyboardShortcut("4", () => handleSetTab(tabs[3] as any), { enabled: shortcutsEnabled });
  useKeyboardShortcut("5", () => handleSetTab(tabs[4] as any), { enabled: shortcutsEnabled });
  useKeyboardShortcut("6", () => handleSetTab(tabs[5] as any), { enabled: shortcutsEnabled });
}
